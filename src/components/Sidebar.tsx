...
export default function Sidebar({ 
  ...
  return (
    <aside 
      ...
      className="w-64 bg-white border-r border-slate-100 flex flex-col h-screen sticky top-0 shrink-0"
    >
      {/* Brand Section */}
      <div id="sidebar-logo-lockup" className="p-8 flex items-center gap-3">
